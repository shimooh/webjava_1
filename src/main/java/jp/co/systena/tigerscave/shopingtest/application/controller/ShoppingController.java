...
import jp.co.systena.tigerscave.shopingtest.application.model.Cart;
import jp.co.systena.tigerscave.shopingtest.application.model.DeleteForm;
import jp.co.systena.tigerscave.shopingtest.application.model.Item;
import jp.co.systena.tigerscave.shopingtest.application.model.ListForm;
import jp.co.systena.tigerscave.shopingtest.application.model.Order;
...
public class ShoppingController {
    ...
    //一覧表示
    @RequestMapping(value = "/itemlist", method = RequestMethod.GET) //GETで情報を取得する
